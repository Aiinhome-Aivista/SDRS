...
export class Service_authorization {
    ...
    upload(file): Observable<any> {
        return this.http.post("http://122.163.121.176:3005/uploads", file)
    }
    ...
    sendChatMessage(payload: { query: string }): Observable<any> {
        return this.http.post("http://122.163.121.176:3005/chat", payload);
    }
}
